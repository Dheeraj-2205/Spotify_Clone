...
<nav>
  ...
  <div class="left_nav_list_two">
    <div>
      <a href="#">
        <div class="left_nav_icon_container">
          <div class="icon_special_container">
  ...
  <section class="top_nav_right">
    ...
    <div class="user_pop" id="user_pop">
      ...
      <div id="user_options">
        <div>
          <span>Account</span>
          <svg role="img" height="16" width="16" aria-hidden="true" aria-label="External link" viewBox="0 0 16 16">
            <path
...
<nav>
  <section class="top_nav_left">
    ...
    <div class="search_bar_container">
      ...
      <input type="text" name="search_bar" id="search_bar" placeholder="What do you want to listen to?">
    </div>
  </section>
  <section class="top_nav_right">
      <div class="user_pop" id="user_pop">
...
export { left_nav, top_nav, loggedOutBottom, top_nav_login, playerBottom, top_nav_search };